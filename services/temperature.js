...
var SERVICE_NAME = 'cpu temperatures';
var SUBSCRIBED_TOPIC = '/cpu/temperature';
...
var sub = {
  ...
  type: 'pandora_sensor_msgs/Temperature'
};
...
ws.on('message', function(chunk) {
  ...
  socket.emit('service/sensors/temperature', data.msg.temperature);
});
